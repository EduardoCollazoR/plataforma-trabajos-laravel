...
<div class="container mx-auto">
    <div class="flex flex-wrap justify-center">
        <div class="w-full max-w-sm">
            <div class="flex-col break-words bg-white border-2 shadow-md mt-20">
                <div class="bg-gray-300 text-gray-700 uppercase text-center py-3 px-6 mb-0">
                    {{ __('Reset Password') }}
                </div>


                <form method="POST" class="py-10 px-5" action="{{ route('password.update') }}" novalidate>
                    @csrf
                    ...
                    <div class="flex flex-wrap mb-6">
                        ...
                        <input id="password-confirm" type="password" class="bg-red-100 border-l-4 border-red-500 text-red-700 p-4 w-full mt-5 text-sm" name="password_confirmation" autocomplete="new-password">
