<aside class="md:w-2/5 bg-teal-500 p-5 rounded m-3">
    ...
    <form action="{{ route('candidatos.store')}}" method="post" enctype="multipart/form">
        @csrf
        <div class="mb-4">
            <label for="nombre" class="block text-white text-sm font-bold mb-4">
                Nombre:
            </label>
            <input type="text" id="nombre" name="nombre" class="p-3 bg-gray-100 rounded form-input w-full @error('nombre') border border-red-500
        ...
        <div class="mb-4">
            ...
            <input type="text" id="email" name="email" class="p-3 bg-gray-100 rounded form-input w-full @error('email') border border-red-500
        ...
        <div class="mb-4">
            ...
            <input type="file" id="cv" name="cv" class="p-3 rounded form-input w-full @error('cv') border border-red-500
            @enderror" accept="application/pdf">
