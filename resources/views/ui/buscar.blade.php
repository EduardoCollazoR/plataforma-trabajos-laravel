...
<form action="{{route('vacantes.buscar')}}" method="POST">
    ...
    <button type="submit" class="bg-teal-500 w-full hover:bg-teal-700 text-gray-100 font-bold p-3 focus:outline-none focus:shadow-outline uppercase mt-10">Buscar Vacantes</button>
</form>
