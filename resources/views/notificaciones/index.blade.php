...
<ul class="max-w-md mx-auto mt-10">
    ...
    <li class="p-5 border border-gray-400 mb-5">
        ...
        <p class="mb-4">
            Te escribio hace: <span class="font-bold">{{$notificacion->created_at->diffForHumans}}</span>
        </p>

        <a href="{{route('candidato.index',['id'=>$data['id_vacante']])}}" class="mb-4 bg-teal-500 p-3 inline-block text-xs font-bold uppercase text-white">
            Ver candidatos
        </a>
