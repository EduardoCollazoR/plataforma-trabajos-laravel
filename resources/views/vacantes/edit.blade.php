...
<form action="{{route('vacantes.update',['vacante'=>$vacante->id])}}" method="POST" class="max-w-lg mx-auto my-10">
    ...
    <div class="mb-5">
        ...
        <input id="titulo" type="text" class="p-3 bg-white rounded form-input w-full @error('password') is-invalid @enderror" name="titulo" placeholder="Titulo de la Vacante" value="{{$vacante->titulo}}">
        @error('titulo')
    ...
    <div class="mb-5">
        ...
        <input type="hidden" name="descripcion" id="descripcion" value="{{$vacante->descripcion}}"></input>
        @error('descripcion')
        <div class="bg-red-500 border border-red-400 text-red-700 px-4 py-3 rounded relative mt-3 mb-6" role="alert">
            <strong class="font-bold">Error!</strong>
            <span class="block">{{$message}}</span>
